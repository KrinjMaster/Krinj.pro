...
<div id="sidebar" class={`fixed h-full w-1/3 flex flex-col justify-between bg-sidebar text-white font-extrabold text-7xl p-8 z-10 transition-opacity ease-linear whitespace-nowrap cursor-auto`}>
  <div class="flex flex-col gap-2.5 items-center">
    ...
    <p class="hover:scale-x-125 transition-all duration-150 ease-linear">About me</p>
    <p class="hover:scale-x-125 transition-all duration-150 ease-linear">Works</p>
  </div>
  <div class="flex gap-5">
    <a tabindex="-1" target="_blank" href="https://github.com/KrinjMaster" class="hover:scale-125 transition-transform duration-150 ease-linear">
